...
<body>
	...
	<div class="demoTable">
		...
		<div class="layui-inline">
			...
			<div class="layui-inline">
				<input class="layui-input" name="username" id="username" autocomplete="on">
			</div>
		</div>
		...
		<div class="layui-inline">
			...
			<div class="layui-inline">
				<input class="layui-input" name="available" id="available" autocomplete="on">
			</div>
		</div>
		-->
  ...
  <script type="text/html" id="barDemo">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="bind">绑定角色</a>
  </script>
	...
	<script>
		...
		layui.use(['table','form'], function() {
			...
			var myTable = table.render({
				elem : '#LAY_table_user',
				url : '${pageContext.request.contextPath }/userBindRolesTable',
				cols : [ [ {
					checkbox : true,
					fixed: 'left',
				}, {
			    	    ...
			    	    success:function(content){
			    	    	layer.open({
					    		...
					    		yes:function(index, layero){
					    			 var d = $("#bindRole").serializeObject();
					    			 d['id'] = data.id;
					    			 console.log(d);
					    			 $.ajax({
					    				 url:"bindRoles",
